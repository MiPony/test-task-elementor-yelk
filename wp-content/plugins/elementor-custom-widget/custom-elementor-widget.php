<?php
/**
 * Plugin Name: Elementor Widget for block Our Team
 * Description: Custom elementor widget
 * Version: 1.0.0
 * Author: Oleg Pelyh
 * Author URI: https://docs.google.com/document/d/1pN6f_NghfwIb4gppzcbtWPFRO8S3kbnyd8239hLu0Ls/edit
 ...
 * @since 1.0.0
 */
final class Custom_Elementor_Widget {
    ...
    */
    public function i18n() {
       load_plugin_textdomain( 'custom-elementor-widget', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
    }
    ...
    */
    public function init_category() {
        Elementor\Plugin::instance()->elements_manager->add_category(
            'myew-for-elementor',
            [
                'title' => 'Custom Elementor Widgets'
            ],
            1
        );
    }
    ...
    */
    public function admin_notice_missing_main_plugin() {
        ...
        $message = sprintf(
            ...
            '<strong>'.esc_html__( 'Custom Elementor Widget', 'custom-elementor-widget' ).'</strong>',
...
Custom_Elementor_Widget::instance();