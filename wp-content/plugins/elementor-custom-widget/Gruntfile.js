    ...
    grunt.initConfig( {
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'custom-elementor-widget',
                    type: 'wp-plugin',
                }
            }
        },
        ...
        compress: {
            main: {
                options: {
                    mode: 'zip',
                    archive: './build/custom-elementor-widget-v-' + pkg.version + '.zip',
                },
                expand: true,
                cwd: 'build/',
                src: [ '**/*' ],
                dest: 'custom-elementor-widget'
            }
        },
        ...
        addtextdomain: {
            options: {
                textdomain: 'custom-elementor-widget',
                updateDomains: [ 'custom-elementor-widget' ]
            },
            target: {
                files: {
                    src: [
